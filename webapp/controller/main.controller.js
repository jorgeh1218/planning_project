sap.ui.define([
	...
	return Controller.extend("PlanificadorAppv2.controller.main", {
		...
		pullSupplyPlan: function() {
			...
			var URL = "/SimpleFarm/services/XSJS/operationFoodPlan2.xsjs?housingPlanID="+ model.getProperty("/INTERNAL_housingSelected/HOUSINGPLANID") +
			"&method=forPlanning&clientID=10&PARTNERID=57";
		...
		getWeek: function(value) {
			...
			var onejan = new Date(currentDate.getFullYear(), 0, 1);// January First
			return Math.ceil((((value - onejan) / 86400000) + onejan.getDay() + 1) / 7);
		},
		onChangeHousingDate: function(oEvent) {
			...
			console.log("Getting week number " + this.getWeek(housing));
